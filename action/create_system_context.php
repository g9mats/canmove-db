...
<form action="<?php echo $DrAction ?>" method="post">
	...
	<table><tr>
	<td>Context Type:</td>
	<td><input id="context_type" name="context_type" required="required" value="" /></td>
...
?>
	...
	<td>Context Key:</td>
	<td><input id="context_key" name="context_key" required="required" value="" /></td>
...
?>
	...
	<td>Object Type:</td>
	<td><input id="object_type" name="object_type" required="required" value="" /></td>
...
?>
	...
	<td>Object Key:</td>
	<td><input id="object_key" name="object_key" required="required" value="" /></td>
...
?>
	...
	<td>Object Key 2:</td>
	<td><input id="object_key2" name="object_key2" required="required" value="" /></td>
