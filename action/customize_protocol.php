...
<p>
Create customized protocol with exactly the variables you want to use. The result will be an XML file (can be read by e.g. Excel).
</p>
<p>
...
?>
	...
	<td>Include Help Text:</td>
	<td><select name="help_text" required="required">
