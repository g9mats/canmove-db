...
<p>
Register files in the server file archive. This will attach key values to the files like e.g. Animal Id, Device Id, Period or Version.
</p>
<p>
Select dataset in the listbox. You will only find those datasets that you have write access to and for which you have uploaded files of a data subset that is supposed to be registered and with a data type that is supported by this registration utility.
</p>
