...
echo "</script>";
$ajax_file=$WebRoot."/db/action/delete_files_subset.php";
$ajax_file2=$WebRoot."/db/action/delete_files_status.php";
$ajax_file3=$WebRoot."/db/action/delete_files_file.php";
...
<p>
Delete files from server file archive. Any data from file that has been loaded into temporary database storage will also be deleted.
</p>
<p>
You must select dataset and then data subset and data status before you can select files. You will only find those datasets that you have write access to and for which there are files in the server file archive.
</p>
